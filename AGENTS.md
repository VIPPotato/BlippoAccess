...
- Target framework: `net472` (game runtime `net35`)
- Output: `bin/Debug/net472/BlippoAccess.dll` -> auto-copied to `I:\SteamLibrary\steamapps\common\Blippo+\Mods\`

## Notes

- Unity `6000.0.58f2`
- Game localization uses `NobleRobot.LanguageUtility.currentLanguage`
